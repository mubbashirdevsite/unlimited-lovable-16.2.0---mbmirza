...
var QL_WHATSAPP_CHANNEL = "https://wa.me/923097241920";
...
function templateChannelGate(minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      ...
      '<img class="ql-title-logo" src="' + chrome.runtime.getURL('assets/logo-master-lovable-square.png') + '" alt=""><span class="ql-title ql-title-stack"><span>Mirza-Lovable</span><small>Lovable</small></span>' +
    '</div>' +
    '<div class="ql-header-right">' +
       '<span class="ql-badge">v' + extensionVersionShort() + '</span>' +
      '<button class="ql-icon-btn ql-lang-btn" title="Language" aria-label="Language">ع</button>' +
  ...
  '<div id="ql-body">' +
    '<div class="ql-license-gate ql-channel-gate">' +
      ...
      '<a href="' + QL_WHATSAPP_CHANNEL + '" data-ext-link="whatsapp" target="_blank" rel="noopener noreferrer" class="ql-community-btn ql-community-btn-wa">💬 Join WhatsApp Channel</a>' +
...
function templateLicenseGate(minimized) {
  ...
  '<div id="ql-body">' +
    '<div class="ql-license-gate">' +
      ...
      '<a href="' + QL_DISCORD_SUPPORT + '" data-ext-link="official_channel" target="_blank" rel="noopener noreferrer" class="ql-buy-btn" style="display:block;text-align:center;text-decoration:none">🔑 Open YouTube Channel</a>' +
    '</div>' +
  '</div>' +
  '<div id="ql-resize-handle" class="ql-resize-handle"></div>';
}
...
function templateMainUI(greeting, statusBadge, minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      '<span class="ql-brand"><img class="ql-brand-logo" src="' + chrome.runtime.getURL('assets/logo-master-lovable-square.png') + '" alt=""><span class="ql-brand-copy"><span class="ql-brand-name">Mirza-Lovable</span><span class="ql-brand-subtitle">Lovable</span></span></span>' +
    '</div>' +
    '<div class="ql-header-right">' +
  ...
  '</div>' +
   '<div id="ql-body">' +
    ...
    '<div id="ql-reseller-btn" style="display:none;margin-bottom:14px">' +
      '<a href="' + QL_DISCORD_SUPPORT + '" data-ext-link="official_channel" target="_blank" rel="noopener noreferrer" class="pk-discord-cta">' +
  ...
  '<div id="ql-footer" class="ql-footer">' +
    '<div class="ql-footer-row">' +
      '<a href="' + QL_DISCORD_SUPPORT + '" data-ext-link="official_channel" target="_blank" class="ql-support-link">' + SVG_ICONS.headphones + ' Support</a>' +
       '<span class="ql-footer-version">v' + extensionVersionShort() + '</span>' +
    '</div>' +
    '<span class="ql-badge-mz">Mirza-Lovable</span>' +
  '</div>' +
  '<div id="ql-resize-handle" class="ql-resize-handle"></div>' +
  '<!-- Notifications Panel -->' +
...
function qlTemplateUpdateBanner(version, changelog, dlUrl, isMandatory) {
...
function qlTemplateMandatoryOverlay(version, changelog, dlUrl) {
  return '<div class="pk-update-overlay" id="ql-mandatory-update">' +
    '<div class="pk-update-overlay-card">' +
      '<div class="pk-update-overlay-icon">⚠️</div>' +
      '<h2 class="pk-update-overlay-title">Update required — v' + version + '</h2>' +
      ...
      '<p class="pk-update-overlay-hint">After downloading, open <code>chrome://extensions</code>, remove the old version and load the new one.</p>' +
    '</div>' +
  '</div>';
}
...
function templateWhatsAppPopup() {
  return `
    <div id="ql-whatsapp-overlay" class="ql-overlay ql-community-overlay">
      <div class="ql-community-modal" role="dialog" aria-modal="true" aria-label="Join Mirza-Lovable">
        <button id="ql-wa-close" class="ql-community-close" type="button" aria-label="Close">&times;</button>
        <div class="ql-community-logo" aria-hidden="true">🚀</div>
        <h2 class="ql-community-title">Join Mirza-Lovable</h2>
        <div class="ql-community-subtitle">Community</div>
        ...
        <div class="ql-community-actions">
          <a href="${QL_WHATSAPP_CHANNEL}" data-ext-link="whatsapp" target="_blank" rel="noopener noreferrer" id="ql-wa-join" class="ql-community-btn ql-community-btn-wa">💬 Join WhatsApp Channel</a>
          <a href="${QL_YOUTUBE_CHANNEL}" data-ext-link="youtube" target="_blank" rel="noopener noreferrer" id="ql-yt-join" class="ql-community-btn ql-community-btn-yt">▶ Join YouTube Channel</a>
        </div>
...
function templateCheckoutScreen(pkg, minimized) {
  ...
  '<div id="ql-body">' +
    '<div class="ql-pay-section" style="text-align:center">' +
      ...
      '<a href="' + QL_DISCORD_SUPPORT + '" data-ext-link="official_channel" target="_blank" rel="noopener noreferrer" class="ql-confirm-pay-btn" style="display:block;text-decoration:none;margin-bottom:10px">💬 Open Official Channel</a>' +
